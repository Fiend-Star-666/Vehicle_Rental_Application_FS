...
class CreateVehicleComponent extends Component {
    ...
    saveVehicle = (e) => {
        ...
        let vehicle = {
            ...
            carRentalLocation: this.state.carRentalLocation,
            vehicle_log: this.state.vehicle_log,
            vehiclereservation: this.state.vehiclereservation,
            parkingstall: this.state.parkingstall,
    ...
    render() {
        ...
        if (this.state.vtype != 'Car' && this.state.vtype != 'Van' && this.state.vtype != '') {
            elementl = (<input placeholder="Type" name="type" className="form-control" value={this.state.type}
                            ...
                            <div className="card-body">
                                <form>
                                    ...
                                    <div className="form-group">
                                        ...
                                        <div>
                                            <select placeholder="Vehicle Type" value={this.state.vtype}
                                                    onChange={this.changeVTypeHandler}>
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input placeholder="Passenger Capacity" name="passengerCapacity"
                                               className="form-control"
                                               value={this.state.passengerCapacity}
                                               onChange={this.changePassengerCapacityHandler}/>
                                    </div>
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input placeholder="Manufacturing Year" name="manufacturingYear"
                                               className="form-control"
                                               value={this.state.manufacturingYear}
                                               onChange={this.changeManufacturingYearHandler}/>
                                    </div>
                                    ...
                                    <div>
                                        <label>Status:</label>
                                        <div>
                                            <select placeholder="Status" value={this.state.status}
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            <select placeholder="Car Rental Location"
                                                    value={this.state.carRentalLocation}
                                                    onChange={this.changeCarRentalLocationHandler}>
                                    ...
                                    <div className="form-group">
                                        ...
                                        <div>
                                            <select placeholder="Parking Stall" value={this.state.parkingstall}
                                                    onChange={this.changeParkingStallHandler}>
