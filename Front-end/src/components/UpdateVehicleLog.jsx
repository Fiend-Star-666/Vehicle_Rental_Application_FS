...
class UpdateVehicleLog extends Component {
    ...
    updateVehicleLog = (e) => {
        ...
        e.preventDefault();
        let vehicleLog = {
            vehicleLogId: this.state.vehicleLogId,
                            ...
                            <div className="card-body">
                                <form>
                                    ...
                                    <div>
                                        ...
                                        <select placeholder="Vehicle Log Type" value={this.state.type}
                                    ...
                                    <div className="form-group">
                                        <DatePicker selected={this.state.creationDate}
                                                    onChange={this.changeCreationDateHandler}
                                                    name="startDate" dateFormat="dd/MM/yyyy"/>
                                    </div>
                                    <button className="btn btn-success" onClick={this.updateVehicleLog}>Update Vehicle
                                        log
                                    </button>
                                </form>
                            </div>
