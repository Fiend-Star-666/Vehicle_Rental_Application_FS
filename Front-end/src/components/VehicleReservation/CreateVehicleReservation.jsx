...
//__________________________________________________________________________________________________
    const saveVehicleReservation = (e) => {
        ...
        let vehicleReservation = {
            ...
            vehicleId: selectedVehicleName,
            creationDate: creationDate,
            dueDate: dueDate,
            pickupLocation: selectedcrlid,
            returnLocation: selectedDropcrlid,
            ...
            belongingInsurance: belongingInsurance,
        ...
        if (dueDate >= creationDate) {
            if (saveflag) {
                ...
                return alert("There has been some error Please try again later");
            }
        } else {
                        ...
                        <div className="card-body">
                            <form>
                                ...
                                <div className="form-group">
                                    ...
                                    <DatePicker selected={creationDate} value={creationDate}
                                                onChange={handleCreationDate} dateFormat="dd/MM/yyyy"/>
                                </div>
                                        ...
                                        <select value={pickupLocation} onChange={handleChangePickupLocation}>
                                            {
                                                CRLname.map((element) => {
                                                    return (<option key={element.id}
                                                                    value={element.id}> {element} </option>)
                                                })
                                            }
                                        </select>
                                    </label>
                                ...
                                <div>
                                    ...
                                    <div>
                                        <label>
                                            Select Vehicle:
                                            <br></br>
                                            <select value={selectedVehicleName}
                                                    onChange={handleChangeSelectedVehicleName}>
                                                {elementl}
                                            </select>
                                        </label>
                                    </div>
                                ...
                                <div>
                                    <div>
                                        <label style={{fontSize: 30}}><b>Insurance options:</b>
                                            <div>
                                                <select value={rentalInsurance} onChange={handleRentalInsurance}
                                                        className='mx-3'>
                                                    <option value={null}> {"Choose Yes/No"} </option>
                                                    <option value={"True"}> {"Yes"} </option>
                                                    <option value={"False"}> {"No"} </option>
                                    ...
                                    <label style={{fontSize: 30}}><b>Other Services:</b>
                                        ...
                                        <div className="form-group mx-4">
                                            <label>
                                                Additional Driver:
                                                <div>
                                                    <select value={additionalDriver} onChange={handleAdditionalDriver}
                                                            className='mx-3'>
                                                        <option value={null}> {"Choose Yes/No"} </option>
                                                        <option value={"True"}> {"Yes"} </option>
                                                        <option value={"False"}> {"No"} </option>
