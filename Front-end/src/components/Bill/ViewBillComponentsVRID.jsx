                                    ...
                                    <tr key={billl.id}>
                                        ...
                                        <td>
                                            <button style={{marginLeft: "10px"}}
                                                    onClick={() => this.viewDetailedView(this.state.id)}
                                                    className="btn btn-info">View Detailed View
                                            </button>
                                            <button style={{marginLeft: "10px"}}
                                                    onClick={() => this.viewReservation(this.state.currentUser.accid)}
                                                    className="btn btn-info">View Reservation
                                            </button>
                                        </td>
