                        ...
                        <div className="card col-md-6 offset-md-3 offset-md-3">
                            ...
                            <div className="card-body">
                                <form>
                                    ...
                                    <div className="form-group">
                                        <DatePicker selected={this.state.dateJoined}
                                                    onChange={this.changeDateJoinedHandler} name="startDate"
                                    ...
                                    <br></br>
                                    <button className="btn btn-success" onClick={this.saveReceptionistAccount}>save
                                    </button>
