                ...
                <div className="about-section">
                    ...
                    <div className='card' style={{backgroundColor: 'white', boxShadow: '1px 1px'}}>
                        <p style={{textAlign: 'justify'}}>
                            BoomCar, India's newest car rental solution, emerged in 2022 and operates in 150+ cities
                            nationwide, making it the dominant player in the car-rental market. Founded by Gursimran
                            Singh, BoomCar began as an internship project and quickly gained momentum, igniting the
                            entrepreneurial spirit of its founder. Since then, BoomCar has garnered numerous industry
