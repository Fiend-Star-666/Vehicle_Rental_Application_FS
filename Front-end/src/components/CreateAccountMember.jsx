...
class CreateAccountMember extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            asstatus: 'Active',//dropdown is must due to enum
    ...
    saveMemberAccount = (e) => {
        ...
        let account = {
            ...
            driverLicenseExpiry: this.state.driverLicenseExpiry,
                            ...
                            <div className="card-body">
                                <form onSubmit={this.handleSubmit}>
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input placeholder="Driver License" name="driverLicenseNumber"
                                               className="form-control"
                                               value={this.state.driverLicenseNumber}
                                               onChange={this.changeDriverLicenseNumberHandler}/>
                                    </div>
                                    ...
                                    <div className="form-group">
                                        <DatePicker
                                            ...
                                            scrollableYearDropdown // Add this line to make the year dropdown scrollable
                                        />
                                    </div>
                                    ...
                                    {/*<div>
                                        ...
                                        <div>
                                            <select placeholder="Account Status" value={this.state.status}
